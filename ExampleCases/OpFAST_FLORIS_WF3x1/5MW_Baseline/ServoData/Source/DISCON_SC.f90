...
open(61, file='DISCON.txt',action='write',position='append')
write(61,*) "CIAO ", from_SC(1)
close(61)
print*, 'CIAO DISCON_SC', from_SC(1)
PC_MinPit = from_SC(1) !Set minimum pitch to input from supercontroller
print*, 'PC_Minpit', PC_MinPit
...
to_SC(1) = 20       ! Send generator torque to supercontroller
print*, 'CIAO DISCON_SC TO', to_SC(1)
