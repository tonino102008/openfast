...
def DISCON(avrSWAP_py, from_SC_py, to_SC_py):
    ...
    if iStatus >= 0 and aviFAIL_py >= 0:
        ...
        if numpy.isclose(Time, 0.0):
            ...
            ind = numpy.where(yawerrmeas.azimuth_old > azimuth[0] - 2*numpy.pi)
            print(ind[0][0])
            a = 0
            if ind[0][0] == 0:
                ind[0][0] = 1
                ...
                print("OK")
            print(ind[0])
            blmom1into = numpy.interp(azimuth[0] - 2*numpy.pi, [yawerrmeas.azimuth_old[ind[0][0]-1], yawerrmeas.azimuth_old[ind[0][0]]], [yawerrmeas.bl1_old[ind[0][0]-1,0], yawerrmeas.bl1_old[ind[0][0],0]])
            blmom1inti = numpy.interp(azimuth[0] - 2*numpy.pi, [yawerrmeas.azimuth_old[ind[0][0]-1], yawerrmeas.azimuth_old[ind[0][0]]], [yawerrmeas.bl1_old[ind[0][0]-1,1], yawerrmeas.bl1_old[ind[0][0],1]])
            blmom2into = numpy.interp(azimuth[0] - 2*numpy.pi + 2*numpy.pi/3, [yawerrmeas.azimuth_old[ind[0][0]-1] + 2*numpy.pi/3, yawerrmeas.azimuth_old[ind[0][0]] + 2*numpy.pi/3], [yawerrmeas.bl2_old[ind[0][0]-1,0], yawerrmeas.bl2_old[ind[0][0],0]])
            blmom2inti = numpy.interp(azimuth[0] - 2*numpy.pi + 2*numpy.pi/3, [yawerrmeas.azimuth_old[ind[0][0]-1] + 2*numpy.pi/3, yawerrmeas.azimuth_old[ind[0][0]] + 2*numpy.pi/3], [yawerrmeas.bl2_old[ind[0][0]-1,1], yawerrmeas.bl2_old[ind[0][0],1]])
            blmom3into = numpy.interp(azimuth[0] - 2*numpy.pi + 4*numpy.pi/3, [yawerrmeas.azimuth_old[ind[0][0]-1] + 4*numpy.pi/3, yawerrmeas.azimuth_old[ind[0][0]] + 4*numpy.pi/3], [yawerrmeas.bl3_old[ind[0][0]-1,0], yawerrmeas.bl3_old[ind[0][0],0]])
            blmom3inti = numpy.interp(azimuth[0] - 2*numpy.pi + 4*numpy.pi/3, [yawerrmeas.azimuth_old[ind[0][0]-1] + 4*numpy.pi/3, yawerrmeas.azimuth_old[ind[0][0]] + 4*numpy.pi/3], [yawerrmeas.bl3_old[ind[0][0]-1,1], yawerrmeas.bl3_old[ind[0][0],1]])
            if a == 1:
                ind[0][0] = 0
            N = 1
            print("OK")
            mo10= numpy.trapz(numpy.hstack((blmom1into, yawerrmeas.bl1_old[ind[0],0])), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))/(2*N*numpy.pi)
            mo1c= numpy.trapz(numpy.multiply(numpy.hstack((blmom1into, yawerrmeas.bl1_old[ind[0],0])), numpy.cos(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))/(N*numpy.pi)
            print("OK")
            mo1s= numpy.trapz(numpy.multiply(numpy.hstack((blmom1into, yawerrmeas.bl1_old[ind[0],0])), numpy.sin(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))/(N*numpy.pi)
            mi10= numpy.trapz(numpy.hstack((blmom1inti, yawerrmeas.bl1_old[ind[0],1])), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))/(2*N*numpy.pi)
            mi1c= numpy.trapz(numpy.multiply(numpy.hstack((blmom1inti, yawerrmeas.bl1_old[ind[0],1])), numpy.cos(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))/(N*numpy.pi)
            mi1s= numpy.trapz(numpy.multiply(numpy.hstack((blmom1inti, yawerrmeas.bl1_old[ind[0],1])), numpy.sin(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])))/(N*numpy.pi)
            mo20= numpy.trapz(numpy.hstack((blmom2into, yawerrmeas.bl2_old[ind[0],0])), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)/(2*N*numpy.pi)
            mo2c= numpy.trapz(numpy.multiply(numpy.hstack((blmom2into, yawerrmeas.bl2_old[ind[0],0])), numpy.cos(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)/(N*numpy.pi)
            mo2s= numpy.trapz(numpy.multiply(numpy.hstack((blmom2into, yawerrmeas.bl2_old[ind[0],0])), numpy.sin(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)/(N*numpy.pi)
            mi20= numpy.trapz(numpy.hstack((blmom2inti, yawerrmeas.bl2_old[ind[0],1])), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)/(2*N*numpy.pi)
            mi2c= numpy.trapz(numpy.multiply(numpy.hstack((blmom2inti, yawerrmeas.bl2_old[ind[0],1])), numpy.cos(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)/(N*numpy.pi)
            mi2s= numpy.trapz(numpy.multiply(numpy.hstack((blmom2inti, yawerrmeas.bl2_old[ind[0],1])), numpy.sin(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 2*numpy.pi/3)/(N*numpy.pi)
            mo30= numpy.trapz(numpy.hstack((blmom3into, yawerrmeas.bl3_old[ind[0],0])), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)/(2*N*numpy.pi)
            mo3c= numpy.trapz(numpy.multiply(numpy.hstack((blmom3into, yawerrmeas.bl3_old[ind[0],0])), numpy.cos(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)/(N*numpy.pi)
            mo3s= numpy.trapz(numpy.multiply(numpy.hstack((blmom3into, yawerrmeas.bl3_old[ind[0],0])), numpy.sin(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)/(N*numpy.pi)
            mi30= numpy.trapz(numpy.hstack((blmom3inti, yawerrmeas.bl3_old[ind[0],1])), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)/(2*N*numpy.pi)
            mi3c= numpy.trapz(numpy.multiply(numpy.hstack((blmom3inti, yawerrmeas.bl3_old[ind[0],1])), numpy.cos(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)/(N*numpy.pi)
            mi3s= numpy.trapz(numpy.multiply(numpy.hstack((blmom3inti, yawerrmeas.bl3_old[ind[0],1])), numpy.sin(numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)), x=numpy.hstack((azimuth[0] - 2*numpy.pi, yawerrmeas.azimuth_old[ind[0]])) + 4*numpy.pi/3)/(N*numpy.pi)
        ...
        if numpy.isclose(Time, 0.0):
            ...
            wryaw = yawerrmeas.wryaw_f[-1]
        else:
            azimuth = numpy.array([(xsol[-1,2] % (numpy.pi*2)), ((xsol[-1,2] + 2*numpy.pi/3) % (numpy.pi*2)), ((xsol[-1,2] + 4*numpy.pi/3) % (numpy.pi*2))])
            #wryaw = xsol[-1,0]
            yawerrmeas.wryaw[-2] = yawerrmeas.wryaw[-1]
            yawerrmeas.wryaw[-1] = xsol[-1,0]
            yawerrmeas.wryaw_f[-2] = yawerrmeas.wryaw_f[-1]
            yawerrmeas.wryaw_f[-1] = (-(yawerrmeas.dtFAST - yawerrmeas.tau_mis)*yawerrmeas.wryaw_f[-2] + yawerrmeas.dtFAST*yawerrmeas.wryaw[-1] + yawerrmeas.dtFAST*yawerrmeas.wryaw[-2])/(yawerrmeas.dtFAST + yawerrmeas.tau_mis) 
            wryaw = yawerrmeas.wryaw_f[-1]
