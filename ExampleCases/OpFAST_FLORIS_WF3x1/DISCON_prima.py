...
def DISCON(avrSWAP_py, from_SC_py, to_SC_py):
    ...
    if iStatus >= 0 and aviFAIL_py >= 0:
        ...
        pitch_obs = avrSWAP_py[3]*180/numpy.pi
        if pitch_obs > 15:
            pitch_obs = 15
        elif pitch_obs < -10:
            pitch_obs = -10
        ...
        vento_obs = optim.fsolve(OBSERVER.func_impl, 4.5, args=(num, pitch_obs))
        ...
        m_out1 = (-(yawerrmeas.dtFAST - tau)*yawerrmeas.m_out1[-2] + yawerrmeas.dtFAST*yawerrmeas.blmom1_tr[-1,0] + yawerrmeas.dtFAST*yawerrmeas.blmom1_tr[-2,0])/(yawerrmeas.dtFAST + tau) 
        m_in1 = (-(yawerrmeas.dtFAST - tau)*yawerrmeas.m_in1[-2] + yawerrmeas.dtFAST*yawerrmeas.blmom1_tr[-1,1] + yawerrmeas.dtFAST*yawerrmeas.blmom1_tr[-2,1])/(yawerrmeas.dtFAST + tau) 
        m_out2 = (-(yawerrmeas.dtFAST - tau)*yawerrmeas.m_out2[-2] + yawerrmeas.dtFAST*yawerrmeas.blmom2_tr[-1,0] + yawerrmeas.dtFAST*yawerrmeas.blmom2_tr[-2,0])/(yawerrmeas.dtFAST + tau) 
        m_in2 = (-(yawerrmeas.dtFAST - tau)*yawerrmeas.m_in2[-2] + yawerrmeas.dtFAST*yawerrmeas.blmom2_tr[-1,1] + yawerrmeas.dtFAST*yawerrmeas.blmom2_tr[-2,1])/(yawerrmeas.dtFAST + tau) 
        m_out3 = (-(yawerrmeas.dtFAST - tau)*yawerrmeas.m_out3[-2] + yawerrmeas.dtFAST*yawerrmeas.blmom3_tr[-1,0] + yawerrmeas.dtFAST*yawerrmeas.blmom3_tr[-2,0])/(yawerrmeas.dtFAST + tau) 
        m_in3 = (-(yawerrmeas.dtFAST - tau)*yawerrmeas.m_in3[-2] + yawerrmeas.dtFAST*yawerrmeas.blmom3_tr[-1,1] + yawerrmeas.dtFAST*yawerrmeas.blmom3_tr[-2,1])/(yawerrmeas.dtFAST + tau)
