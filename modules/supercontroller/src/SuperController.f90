...
!..................................................................................................................................
   ...
   print*, "SC_SET INPUTS FORTRAN ROUTINE 1==2", y_SrvD%SuperController(1)
   print*, "SC_SET OUTPUTS FORTRAN ROUTINE 1==2 SHAPE", shape(y_SrvD%SuperController)
   ...
   print*, "SC_SET INPUTS FORTRAN ROUTINE 1", SC%u%toSC(1)
   print*, "SC_SET INPUTS FORTRAN ROUTINE 1 SHAPE", shape(SC%u%toSC)
...
!..................................................................................................................................
   ...
   print*, "SC_SET OUTPUTS FORTRAN ROUTINE 1", SC%y%fromSC(1)
   print*, "SC_SET OUTPUTS FORTRAN ROUTINE 1 SHAPE", shape(SC%y%fromSC)
      ! set SuperController inputs
   if (p_FAST%CompServo == Module_SrvD) then
      if (allocated(u_SrvD%SuperController).and. associated(SC%y%fromSC)) u_SrvD%SuperController = SC%y%fromSC
   end if
   print*, "SC_SET OUTPUTS FORTRAN ROUTINE 1==2", u_SrvD%SuperController(1)
   print*, "SC_SET OUTPUTS FORTRAN ROUTINE 1==2 SHAPE", shape(u_SrvD%SuperController)
