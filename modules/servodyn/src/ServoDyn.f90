...
!..................................................................................................................................
   ...
   IF (InitInp%NumSC2Ctrl > 0 .and. p%UseBladedInterface) THEN
      print*, "NumSC2Ctrl", InitInp%NumSC2Ctrl    
   ...
   IF (InitInp%NumCtrl2SC > 0 .and. p%UseBladedInterface) THEN
      print*, "NumCtrl2SC", InitInp%NumCtrl2SC    
...
!..................................................................................................................................
   ...
   CALL ReadVar( UnIn, InputFile, InputFileData%OutFmt, "OutFmt", "Format used for module's text tabular output (except time); resulting field should be 10 characters (-)", ErrStat2, ErrMsg2, UnEc)
      ...
      ! Tstart - Time to start module's tabular output:
...
!..................................................................................................................................
   ...
   LOGICAL                                        :: DLL_TqCon   ! IF TORQUE CONTROL IS ENABLED --> MODIFY ALSO TORQUE OF YAW MODEL
   ...
   IF ( OtherState%BegYawMan )  THEN  ! Override yaw maneuver is occuring.
      ...
      ELSE                             ! Override yaw maneuver in linear ramp
         ...
         print*, "SONO NELL IF CONDITION IN YAW_CALCOUTPUT     -->        OVERRIDE YAW IS ACTIVATED"
   ...
   IF (p%YCMode == ControlMode_DLL) THEN
      IF (ABS(m%dll_data%avrSWAP(29)) < 1e-4) THEN
         y%YawMom = - p%YawSpr *( u%Yaw     - YawPosCom  )     &          ! {-f(qd,q,t)}SpringYaw
                  - p%YawDamp*( u%YawRate - YawRateCom )                ! {-f(qd,q,t)}DampYaw;
         print*, "CASE YAW SPEED CONTROL in Yaw_CalcOutput"
      ELSE
         !y%YawMom = - p%YawSpr * u%Yaw         & ! {-f(qd,q,t)}SpringYaw
         !         - p%YawDamp* u%YawRate + YawRateCom                ! {-f(qd,q,t)}DampYaw;
         y%YawMom = YawRateCom
         print*, "CASE YAW TORQUE CONTROL in Yaw_CalcOutput"
      END IF
   ELSE
      y%YawMom = - p%YawSpr *( u%Yaw     - YawPosCom  )     &          ! {-f(qd,q,t)}SpringYaw
               - p%YawDamp*( u%YawRate - YawRateCom )                ! {-f(qd,q,t)}DampYaw;
   ...
   print*, "YAW_CALCOUTPUT     -->     Commanded YAW MOMENT", y%YawMom
...
SUBROUTINE CalculateStandardYaw(t, u, p, m, YawPosCom, YawRateCom, ErrStat, ErrMsg)
   ...
   REAL(ReKi),                     SAVE           :: YawPosComInt   !< Commanded yaw angle from user-defined routines, rad.
   ...
   IF ( t >= p%TYCOn  .AND.  p%YCMode /= ControlMode_NONE )  THEN   ! Time now to enable active yaw control.
      ...
      SELECT CASE ( p%YCMode )  ! Which yaw control mode are we using? (we already took care of ControlMode_None)
         ...
         CASE ( ControlMode_DLL )                                ! User-defined yaw control from Bladed-style DLL
            ...
            IF (ABS(m%dll_data%avrSWAP(29)) < 1e-4) THEN
               YawPosComInt  = YawPosComInt + m%dll_data%YawRateCom*p%DT !bjj: was this: LastYawPosCom + YawRateCom*( ZTime - LastTime )
               YawPosCom  =         YawPosComInt  
               YawRateCom =         m%dll_data%YawRateCom
               print*, "CASE YAW SPEED CONTROL in CalculateStandardYaw"
            ELSE
               YawRateCom = m%dll_data%YawRateCom     !  Keeping the same variable name, but in Torque CONTROL, it's The TORQUE!!!
               YawPosCom = 0.0_ReKi
               print*, "CASE TORQUE SPEED CONTROL in CalculateStandardYaw"
            ENDIF

            print*, "CalculateStandardYaw -->      YawPosCom", YawPosCom
            print*, "CalculateStandardYaw -->      YawRateCom", YawRateCom
            print*, "CalculateStandardYaw -->      u%Yaw", u%Yaw
            print*, "CalculateStandardYaw -->      u%YawRate", u%YawRate
...
!..................................................................................................................................
   ...
   IF ( t >= p%TYawManS )  THEN  ! Override yaw maneuver is occuring.
      ...
      IF ( .not. OtherState%BegYawMan )  THEN  ! Override yaw maneuver is just beginning (possibly again).
         ...
         print*, "SONO NELL IF CONDITION IN YAW_UPDATESTATES     -->        OVERRIDE YAW IS ACTIVATED"
