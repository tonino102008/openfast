...
SUBROUTINE IfW_UserWind_Init(InitData, ParamData, MiscVars, Interval, InitOutData, ErrStat, ErrMsg)
   ...
   print*, "PARAMETRI VENTO", ParamData%Layout(1,:)
...
SUBROUTINE IfW_UserWind_CalcOutput(Time, PositionXYZ, ParamData, Velocity, DiskVel, MiscVars, ErrStat, ErrMsg)
   ...
   print*, "PARAMETRI CONTATORE TURBINE", k
   ...
   print*, "LOG PROFILE T1", windentrypos(1,1)
   ...
   print*, "LAYOUT", ParamData%Layout(1,:)
   print*, "LAYOUT", ParamData%Layout(2,:)
   print*, "LAYOUT", ParamData%Layout(3,:)
   print*, "LAYOUT", ParamData%Layout(4,:)
   print*, "LAYOUT", ParamData%Layout(5,:)      
   print*, "SORTED + ROTATED LAYOUT", Sortlayout(1,:)
   print*, "SORTED + ROTATED LAYOUT", Sortlayout(2,:)
   print*, "SORTED + ROTATED LAYOUT", Sortlayout(3,:)
   print*, "SORTED + ROTATED LAYOUT", Sortlayout(4,:)
   print*, "SORTED + ROTATED LAYOUT", Sortlayout(5,:)
   ...
   print*, "SORTED + ROTATED LAYOUT Ct", Ct   
   print*, "SORTED + ROTATED LAYOUT a", a
   print*, "SORTED + ROTATED LAYOUT gammat", gammat
   ...
   DO i = 1, turb_loc(k(1)) - 1          !  EVALUATING SPEED AT TURBINES INLET AT (Y,Z) coord required by USER TO OBTAIN AddedTurbulence
      ...
      DO j = i + 1, turb_loc(k(1))  
         ...
         print*, "WAKECALCPOS", wakeveccalcpos(4,:)
         print*, "WAKECALCPOS", wakeveccalcpos(5,:)
      ...
      print*, "VELOCITA IMBOCCO NEL PUNTO RICHIESTO", windentrypos(4,:)
      print*, "VELOCITA IMBOCCO NEL PUNTO RICHIESTO", windentrypos(5,:)
   ENDDO

   print*, "ADDED TURBULENCE", I0vec

   print*, "REQUIRED POSITIONS ", PositionXYZ
   ...
   DO PointNum = 1, NumPoints
      ...
      DO i = 2, SIZE(layoutpos, 1)   ! ERA SIZE(layoutpos, 2)
      ...
      print*, "LAYOUT POS", layoutpos(4,:)
      print*, "LAYOUT POS", layoutpos(5,:)
      ...
      print*, "VELOCITA NEL PUNTO RICHIESTO: SDR LOCALE", (/VelWake, 0.0, 0.0/)
   ENDDO

   print*, "VELOCITA NEL PUNTO RICHIESTO: SDR GLOBALE", Velocity
   ...
   IF (ABS(MOD(REAL(Time,ReKi), 10.0)) < 1e-4) THEN
      ...
      WRITE(UNIT = UnitOutFile, FMT = '((10(F9.4,1X)),I1,I1,I1,I1)', ADVANCE = 'no') IntP(1), IntP(2), IntP(3), Intp(4), Intp(5), Intp(6), Ctin(k(1)), ain(k(1)), gammain(k(1)), I0vec(k(1)), k(1), k(2), k(3), k(4)
   ...
   CONTAINS
      SUBROUTINE WindCalc(Ct, gamma, z_hub, d_rot, Uinf_w, I0, ka, kb, alpha, beta, &
         ...
         IF (PositionXYZ(1) <= x0 .AND. PositionXYZ(1) > 100.0) THEN
            ...
            print*, "POTENTIAL CORE", y_pc_int, z_pc_int, a1_pc, c1_pc, U_init, x0, sz, sy
      ...
      SUBROUTINE IntersectArea(r1, r2, d, gamma, IntArea, IntAreaTurb, Aint)
         ...
         print*, "EQUAZIONE 2° GRADO", r1, aeq, beq, ceq, d1, r2, d
         ...
         print*, "EQUAZIONE 2° GRADO", IntAreaTurb, AInt, Area1, Area2
