...
!!!     TYPE(CTBladed_Backgr)                                        :: BackGrndValues
      ...
      SELECT CASE ( p%WindType )
         ...
         CASE (User_WindNumber)
            ...
            User_InitData%WindFileName   = InputFileData%Uniform_FileName ! I USE THE UNIFORM WIND FIELD TO READ ALSO THE USER INPUT WIND FILE
            User_InitData%LayoutFileName = InputFileData%TSFF_FileName
            User_InitData%FlorisFileName = InputFileData%BladedFF_FileName
