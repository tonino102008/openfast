...
! =========  IfW_UserWind_MiscVarType  =======
  TYPE, PUBLIC :: IfW_UserWind_MiscVarType
    ...
    REAL(ReKi) , DIMENSION(:), ALLOCATABLE  :: AllInAD     !< An array holding the value of all of the calculated (not only selected) output channels [-]
    REAL(ReKi) , DIMENSION(:), ALLOCATABLE  :: BlPos     !< An array holding the value of all of the calculated (not only selected) output channels [-]
    REAL(ReKi) ,               ALLOCATABLE  :: YawAngle     !< An array holding the value of all of the calculated (not only selected) output channels [-]
...
! =========  IfW_UserWind_ParameterType  =======
  TYPE, PUBLIC :: IfW_UserWind_ParameterType
    ...
    INTEGER(IntKi)  :: ierror_w   !<forpy variable for python communication WIND
    TYPE(module_py) :: FLORIS_ROUTINE   !<forpy module to be loaded WIND
    TYPE(list)      :: paths_w    !< path to load FLORIS_ROUTINE module
