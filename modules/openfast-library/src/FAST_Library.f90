...
!GCC$ ATTRIBUTES DLLEXPORT :: FAST_OpFM_Init
   ...
   print*, "NumCtrl2SC", ExternInitData%NumCtrl2SC
   print*, "NumSC2Ctrl", ExternInitData%NumSC2Ctrl
...
subroutine SetOpenFOAM_pointers(iTurb, OpFM_Input_from_FAST, OpFM_Output_to_FAST, SC_Input_from_FAST, SC_Output_to_FAST)
   ...
   print*, "SC_Output_to_FAST%fromSC_Len", SC_Output_to_FAST%fromSC_Len    
   print*, "SC_Input_from_FAST%toSC_Len", SC_Input_from_FAST%toSC_Len    
   print*, "OpFM_Input_from_FAST%SuperController_Len", OpFM_Input_from_FAST%SuperController_Len    
   print*, "OpFM_Output_to_FAST%SuperController_Len", OpFM_Output_to_FAST%SuperController_Len
   print*, "WIND SPEED FROM OPENFOAM IMPORTANT u: ", OpFM_Output_to_FAST%u
   print*, "WIND SPEED FROM OPENFOAM IMPORTANT u: ", Turbine(iTurb)%OpFM%y%c_obj%u
   print*, "WIND SPEED FROM OPENFOAM IMPORTANT v: ", OpFM_Output_to_FAST%v
   print*, "WIND SPEED FROM OPENFOAM IMPORTANT v: ", Turbine(iTurb)%OpFM%y%c_obj%v
   print*, "WIND SPEED FROM OPENFOAM IMPORTANT w: ", OpFM_Output_to_FAST%w
   print*, "WIND SPEED FROM OPENFOAM IMPORTANT w: ", Turbine(iTurb)%OpFM%y%c_obj%w
   print*, "WIND SPEED TO OPENFOAM IMPORTANT u: ", OpFM_Input_from_FAST%pxVel
   print*, "WIND SPEED TO OPENFOAM IMPORTANT u: ", Turbine(iTurb)%OpFM%u%c_obj%pxVel
   print*, "WIND SPEED TO OPENFOAM IMPORTANT v: ", OpFM_Input_from_FAST%pyVel
   print*, "WIND SPEED TO OPENFOAM IMPORTANT v: ", Turbine(iTurb)%OpFM%u%c_obj%pyVel
   print*, "WIND SPEED TO OPENFOAM IMPORTANT w: ", OpFM_Input_from_FAST%pzVel
   print*, "WIND SPEED TO OPENFOAM IMPORTANT w: ", Turbine(iTurb)%OpFM%u%c_obj%pzVel
